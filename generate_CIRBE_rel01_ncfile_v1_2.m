load("mode_times.mat")
trange = ['2023-05-29';'2023-05-29']; %manually updated for specific days
...
for i = start_datenum:end_datenum
    ...
    if fileID_CIRBE_1 > 0
        ...
        valflag = zeros(num_t,1); %updated to ones or zeros, or specific values
        %valflag = ones(num_t,1);
