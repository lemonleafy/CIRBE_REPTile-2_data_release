...
Early in the mission, proton range channels 1-2 were unintentionally combined. As a result, channel 1 received no data, while channel 2 received the sum of both channels' counts. Users should avoid using proton channels 1-2 from 2023-04-19 through 2023-07-30. Measurements taken after 2023-07-30 are not affected by this issue, so channels 1-2 can be used normally. Additionally, proton range channels 47-50 deviate from the expected energy spectrum in a manner that suggests calibration issues with the instrument. Users should treat data in these four channels as unreliable for scientific use unless further correction is available. 
