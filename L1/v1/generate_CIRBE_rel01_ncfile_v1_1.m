load("mode_times.mat") %separate file, for pointing mode
trange = ['2023-04-19';'2023-12-31'];
...
for i = start_datenum:end_datenum
    ...
    file_path_1 = ['CIRBE_L1_combined_science_',file_datestring,'_V0.nc']; %files from internal store
    ...
    if fileID_CIRBE_1 > 0
        ...
        %Datafilename = "CIRBE_REPTile-2_L1_20230623v1_2.nc";
...
ncwrite('CIRBE_REPTile-2_L1_20230514v1_1.nc','invalid_data_flag',vf20230514)
ncwrite('CIRBE_REPTile-2_L1_20230515v1_1.nc','invalid_data_flag',vf20230515)
ncwrite('CIRBE_REPTile-2_L1_20230516v1_1.nc','invalid_data_flag',vf20230516)
ncwrite('CIRBE_REPTile-2_L1_20230517v1_1.nc','invalid_data_flag',vf20230517)
ncwrite('CIRBE_REPTile-2_L1_20230518v1_1.nc','invalid_data_flag',vf20230518)
ncwrite('CIRBE_REPTile-2_L1_20230519v1_1.nc','invalid_data_flag',vf20230519)
