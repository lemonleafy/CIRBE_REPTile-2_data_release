%% Creating files and writing variables
...
for i = start_datenum:end_datenum
    ...
    file_path_1 = ['CIRBE_L1_combined_science_',file_datestring,'_V0.nc']; %files from internal store, data from satellite
    ...
    if fileID_CIRBE_1 > 0
        ...
        valflag = zeros(num_t,1); %flags are added later
...
%% Writing flags for invalid data

tinfo1  = length(ncread("CIRBE_L1_combined_science_2023_05_13_V0.nc","Epoch"));
tinfo2  = length(ncread("CIRBE_L1_combined_science_2023_05_14_V0.nc","Epoch"));
tinfo3  = length(ncread("CIRBE_L1_combined_science_2023_05_15_V0.nc","Epoch"));
tinfo4  = length(ncread("CIRBE_L1_combined_science_2023_05_16_V0.nc","Epoch"));
tinfo5  = length(ncread("CIRBE_L1_combined_science_2023_05_17_V0.nc","Epoch"));
tinfo6  = length(ncread("CIRBE_L1_combined_science_2023_05_18_V0.nc","Epoch"));
tinfo7  = length(ncread("CIRBE_L1_combined_science_2023_05_19_V0.nc","Epoch"));
tinfo8  = length(ncread("CIRBE_L1_combined_science_2023_05_29_V0.nc","Epoch"));
tinfo9  = length(ncread("CIRBE_L1_combined_science_2023_05_30_V0.nc","Epoch"));
tinfo10  = length(ncread("CIRBE_L1_combined_science_2023_06_08_V0.nc","Epoch"));
tinfo11  = length(ncread("CIRBE_L1_combined_science_2023_06_23_V0.nc","Epoch"));

vf20230513 = zeros(tinfo1,1);
vf20230513(2567:tinfo1) = 1;

vf20230514 = ones(tinfo2,1);
vf20230515 = ones(tinfo3,1);
vf20230516 = ones(tinfo4,1);
vf20230517 = ones(tinfo5,1);
vf20230518 = ones(tinfo6,1);

vf20230519 = zeros(tinfo7,1);
vf20230519(1:1031) = 1;

vf20230529 = zeros(tinfo8,1);
vf20230529(463:tinfo8) = 1;

vf20230530 = ones(tinfo9,1);
vf20230608 = ones(tinfo10,1);

vf20230623 = zeros(tinfo11,1);
vf20230623(4991:tinfo11) = 1;

ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230513)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230514)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230515)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230516)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230517)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230518)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230519)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230529)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230530)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230608)
ncwrite('CIRBE_REPTile-2_L1_20230513v1_1.nc','invalid_data_flag',vf20230623)
